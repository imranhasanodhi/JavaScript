...
function task2() {
  ...
  try {
    ...
    if (error instanceof ReferenceError) {
        ...
        console.log('an u¨nspected error occured:', error.message);
    }
  }
}
...
function task4() {
  ...
  try {
    ...
    try {
        throw new Error('Enter in inside nested try block')
    } catch (inner) {
        console.log('Caught inner error;',error.message)
    }
  } catch (outer) {
    console.log('Cought outer error', error.message)
...
function task6(obj, key) {
  ...
  try {
    ...
    if (error instanceof TypeError) {
        ...
        console.log('An enexpected error occurred', error.message)
    }
  }
}

task6({firstName: 'Imran'}, 'firstName')
